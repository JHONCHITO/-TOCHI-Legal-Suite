      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl">{done ? "Contraseña actualizada" : "Crear nueva contraseña"}</CardTitle>
            <CardDescription>
              {done
            ...
            {done ? (
              <div className="space-y-6 py-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Tu contraseña fue actualizada. En unos segundos te llevaremos al inicio de sesión.
                </p>
