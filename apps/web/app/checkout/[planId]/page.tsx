            ...
            <div className="sticky top-8">
              ...
              <div className="border rounded-xl p-6 bg-card">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">{plan.priceMonthly} USD</span>
                </div>
                <div className="flex items-center justify-between mt-2">
                  <span className="font-semibold">Total hoy</span>
                  <span className="text-xl font-bold text-primary">{plan.priceMonthly} USD</span>
                </div>
              </div>

              <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                <p className="text-sm text-muted-foreground text-center">
                  Tu suscripcion incluye 14 dias de prueba gratuita. 
