        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Busca por articulo, epigrafe, tema o palabra clave. Si no aparece nada, abre la busqueda real con IA.
              </CardDescription>
            </CardHeader>
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="mt-2 max-w-lg text-sm text-muted-foreground">
                      Cambia el termino de busqueda o abre la busqueda real para consultar Mongo, la IA y las fuentes oficiales.
                    </p>
                    <Button
                      className="mt-4"
                      variant="outline"
