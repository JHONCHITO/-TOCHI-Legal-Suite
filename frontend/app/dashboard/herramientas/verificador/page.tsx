...
export default function VerificadorDocumentosPage() {
  ...
  const verificarDocumento = async () => {
    if (!numeroDocumento.trim()) {
      toast.error("Ingresa un numero para verificar");
      return;
    }
    ...
    setResultado({
      ...
      estado: "verificando",
      mensaje: "Verificando...",
      fuente: "Base interna TOCHI y fuentes oficiales",
    });
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Verifica cedulas, NIT, tarjetas profesionales, radicados y documentos cargados en TOCHI.
        </p>
      </div>
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ingresa los datos del documento a revisar y TOCHI consultara la base interna.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Las ultimas consultas quedan registradas para auditoria interna.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              {recentVerifications.length === 0 ? (
                <p className="rounded-lg border p-4 text-sm text-muted-foreground">
                  Aun no hay verificaciones guardadas.
                </p>
              ) : (
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Consulta directamente en las fuentes oficiales cuando necesites certificacion externa.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <a
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-1 text-amber-700">
                    Esta herramienta verifica contra la base interna de TOCHI y enlaces oficiales de referencia.
                    Para certificacion externa definitiva, consulte la entidad correspondiente.
                  </p>
                </div>
              </div>
            </CardContent>
